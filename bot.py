...
@bot.message_handler(func=lambda m: user_state.get(m.chat.id) == 'banner_addr')
def banner_addr(message):
    bot.send_message(message.chat.id, "✅ ব্যানার রেডি! Premium না হলে ওয়াটারমার্ক থাকবে।")
